...
export const preventiveStates = [
  {
    ...
    icon: '📊',
    color: '#00C8FF',
    desc: 'ML time-series model continuously analyzes the last 10 sensor arrays',
    active: true,
  },
  {
    id: 'trend_rising',
    label: 'ML DETECTS SPIKE',
    icon: '📈',
    color: '#FFAA00',
    desc: 'Predictive model detects imminent flash flood patterns via simultaneous spikes',
    active: true,
  },
  {
    id: 'pre_open',
    label: 'AUTO PRE-OPEN 50%',
    icon: '🔓',
    color: '#00E676',
    desc: 'Gate pre-emptively opens to 50% based on ML command — before physical thresholds cross',
    active: true,
  },
  {
    id: 'watch',
    ...
    icon: '🎯',
    color: '#C084FC',
    desc: 'If prediction stabilizes → gate adjusts back automatically.',
    active: false,
  },
];
